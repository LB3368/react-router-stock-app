...
import SortColumn from "../../hooks/SortColumn";
import { Typography } from "@mui/material";
import UpgradeIcon from "@mui/icons-material/Upgrade";
import VerticalAlignBottomIcon from "@mui/icons-material/VerticalAlignBottom";
import { Box } from "@mui/system";
import { arrowStyle, btnHoverStyle } from "../../styles/Style";
import DeleteForeverIcon from "@mui/icons-material/DeleteForever";

export default function Products({ selectedProducts, selectedBrands }) {
  const { deleteProduct } = StockCall();
  ...
  const { sortedData, handleSort, columns } = SortColumn(
    products,
    columnObj
  );
